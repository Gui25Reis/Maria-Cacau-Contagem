...
from maria_cacau.design_system.v6.tokens import (COLORS, LAYOUT, FontFamily,
                                                 TypographyToken)
...
class DSButton(QPushButton, DSLoadingHandler):
    ...
    def update_state(self, state: DSButtonState) -> None:
        ...
        # Todo estado parte da mesma base — sem isso, um DISABLED anterior
        # deixaria a opacidade e o enabled=False presos numa transição pra
        # LOADING, já que só DEFAULT limpava esses dois explicitamente.
        self._stop_loading()
